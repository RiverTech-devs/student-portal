...
-- practice sessions for more than one subject (Math Dojo + the new Wordsmith
-- English trainer, which logs sessions with subject='Reading').
--
...
'Curriculum subject this practice session belongs to (matches skill_progress.subject). ''Math'' = Math Dojo; ''Reading'' = Wordsmith (English). Defaults to ''Math'' for backwards compatibility.';
